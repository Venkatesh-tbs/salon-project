// ============================================================
// frontend/src/components/admin/CRMTable.tsx
// ============================================================
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-white/10 overflow-hidden">
          {/* Table header */}
          <div className="grid grid-cols-5 gap-4 px-5 py-3 bg-white/[0.03] border-b border-white/[0.06]">
            {["Client", "Phone", "Visits", "Last Visit", "Spent"].map((h) => (
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((c, i) => (
                <motion.div
                  ...
                  className="grid grid-cols-5 gap-4 px-5 py-4 hover:bg-white/[0.02] transition-colors"
                >
                  {/* Name */}
                  ...
                  {/* Phone */}
                  <p className="text-white/50 text-sm self-center">{c.phoneNumber}</p>
