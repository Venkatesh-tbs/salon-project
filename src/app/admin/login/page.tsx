  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[80vw] h-[60vh] bg-fuchsia-600/15 blur-[120px] rounded-full" />
        <div className="absolute bottom-0 left-0 w-[50vw] h-[40vh] bg-indigo-700/10 blur-[100px] rounded-full" />
      </div>
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-black text-white font-syne tracking-tight">Admin Portal</h1>
            <p className="text-white/40 text-sm mt-1">Sign in to manage your salon</p>
          </div>
          ...
          <p className="text-center text-white/20 text-xs mt-6">
            Staff?{' '}
            <Link href="/staff/login" className="text-white/40 hover:text-white underline transition-colors">
              Log in here
            </Link>
          </p>
        </motion.div>
